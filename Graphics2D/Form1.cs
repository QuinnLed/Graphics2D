...
namespace Graphics2D
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            lblRedScore.Location = new Point(170, 820);
            lblBlueScore.Location = new Point(230, 820);
            lblPlayerTurn.Location = new Point(170, 100);
            ...
            balls.Insert(15, new Ball2D(new Point2D(120, 120), radius, new Point2D(0, 0)));
            balls.RemoveAt(16);
            setupBalls();
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
       {
            ...
            // Update score labels
            lblRedScore.Text = "Red: " + poolTable.ScoreRed.ToString();
            lblBlueScore.Text = "Blue: " + poolTable.ScoreBlue.ToString();
        ...
        {
            // place the origin at the center of the screen
        ...
        private void Form1_MouseDown(object sender, MouseEventArgs e)
        {
            if (poolTable.Player == 1)
            {
                ...
                else if (e.Button == MouseButtons.Left && poolTable.CueBallOut == true)
                {
